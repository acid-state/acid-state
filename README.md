acid-state [![Hackage](https://img.shields.io/hackage/v/acid-state.svg)](https://hackage.haskell.org/package/acid-state) ![Build Status](https://api.travis-ci.org/acid-state/acid-state.svg?branch=master)
==========
